...
namespace esphome {
namespace dummy_dallas {

static const char *const TAG = "dummy.dallas";
...
uint16_t dummyDallas::millis_to_wait_for_conversion_() const {
...
void IRAM_ATTR dummyDallas::read_scratch_pad_int_() {
  for (uint8_t &i : this->scratch_pad_) {
    i = this->bus_->read8();
  }
}

bool dummyDallas::read_scratch_pad_() {
  bool success;
  {
    InterruptLock lock;
...
bool dummyDallas::check_scratch_pad_() {
